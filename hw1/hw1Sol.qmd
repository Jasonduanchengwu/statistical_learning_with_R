...
=\operatorname{E}[((Y - \operatorname{E}(Y|X))+(\operatorname{E}(Y|X)-f(X)))^2]\\
=\operatorname{E}[(Y - \operatorname{E}(Y|X))^2]+2\operatorname{E}[(Y - \operatorname{E}(Y|X))(\operatorname{E}(Y|X)-f(X))]+\operatorname{E}[(\operatorname{E}(Y|X)-f(X))^2]\\
=
$$ 
...
healthcare interventions can be developed for each patient segment based on the health indicators, medical history etc. The patient outcome could be greatly improved with the tailored treatment approach. 
